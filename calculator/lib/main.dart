...
import 'package:calculator/componenets/widgets.dart';
             ...
             Expanded(
               child: Padding(
                 ...
                 child: Column(
                   ...
                   children: [
                     Align(
                         alignment: Alignment.bottomRight,child: Text(userInput.toString(),style: TextStyle(fontSize: 30,color: Colors.white),)),
                     SizedBox(height: 15,),
